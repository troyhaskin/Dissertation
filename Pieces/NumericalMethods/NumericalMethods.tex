...
\begin{figure}%
    \centering
    \caption{Solutions and errors plots for the three approximation methods to \cref{Eqn:NM_Example_BVP}.}
    \begin{subfigure}{\textwidth}
        \centering
        \caption{Six partition solutions.}%
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \caption{L\subs[\;]{2} norm error plots. FEM and FDM exhibit second order convergence; FVM exhibits first order.}%
